...
OUTPUT_DIR="$BASEDIR/BIDS/derivatives/prfanalyze-braincoder.hrf.cpu"
LOG_RUNTIME_FILE="logs/braincoder.hrf.cpu-runtime-${IDENTIFIER}.txt"
PYTHON_OUTPUT_FILE="logs/braincoder.hrf.cpu-output-${IDENTIFIER}.txt"
