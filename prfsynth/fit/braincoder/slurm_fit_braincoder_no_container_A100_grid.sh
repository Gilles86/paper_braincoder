...
OUTPUT_DIR="$BASEDIR/BIDS/derivatives/prfanalyze-braincoder.grid.A100"
LOG_RUNTIME_FILE="logs/braincoder.grid.a100-runtime-${IDENTIFIER}.txt"
PYTHON_OUTPUT_FILE="logs/braincoder.grid.a100-output-${IDENTIFIER}.txt"
