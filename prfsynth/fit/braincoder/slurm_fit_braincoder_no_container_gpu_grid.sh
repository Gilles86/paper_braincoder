...
OUTPUT_DIR="$BASEDIR/BIDS/derivatives/prfanalyze-braincoder.grid.gpu"
LOG_RUNTIME_FILE="logs/braincoder.grid.gpu-runtime-${IDENTIFIER}.txt"
PYTHON_OUTPUT_FILE="logs/braincoder.grid.gpu-output-${IDENTIFIER}.txt"
