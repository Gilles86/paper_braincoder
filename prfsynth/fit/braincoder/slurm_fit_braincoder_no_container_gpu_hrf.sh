...
OUTPUT_DIR="$BASEDIR/BIDS/derivatives/prfanalyze-braincoder.hrf.gpu"
LOG_RUNTIME_FILE="logs/braincoder.hrf.gpu-runtime-${IDENTIFIER}.txt"
PYTHON_OUTPUT_FILE="logs/braincoder.hrf.gpu-output-${IDENTIFIER}.txt"
