...
OUTPUT_DIR="$BASEDIR/BIDS/derivatives/prfanalyze-braincoder.A100"
LOG_RUNTIME_FILE="logs/braincoder.a100-runtime-${IDENTIFIER}.txt"
PYTHON_OUTPUT_FILE="logs/braincoder.a100-output-${IDENTIFIER}.txt"

# Choose the appropriate config file
if [ "$IDENTIFIER" == "vanes2019" ]; then
    CONFIG_FILE="$PWD/configs/vanes2019_config.yml"
else
