...
OUTPUT_DIR="$BASEDIR/BIDS/derivatives/prfanalyze-vista"
LOG_RUNTIME_FILE="logs/vista-runtime-${IDENTIFIER}.txt"
PYTHON_OUTPUT_FILE="logs/vista-output-${IDENTIFIER}.txt"
...
docker run --rm -it \
      ...
      garikoitz/prfanalyze-vista > "$PYTHON_OUTPUT_FILE" 2>&1
